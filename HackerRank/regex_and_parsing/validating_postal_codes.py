...
#
# P must be a number in the range from to 100000 to 999999 inclusive.
...
# from stdin and uses provided expression and your regular expressions to validate if P is a valid postal code.

import re

regex_integer_in_range = r"^[1-9][\d]{5}"  # Do not delete 'r'.
regex_alternating_repetitive_digit_pair = r"(\d)(?=\d1)"  # Do not delete 'r'.
